...
import mobilehealth.wit.myapplication.fragments.CustomFragment;
 ...
 */
public class CalibrateFragment extends CustomFragment implements OnFragmentInteractionListener {
    ...
    public CalibrateFragment(Activity parentActivity) {
